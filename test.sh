...
assert 1 "main(){34>=34;}"
assert 1 "main(){int abc; abc = 1;}"
assert 2 "main(){int a; int b; a = b=2;}"
assert 1 "main(){ int a; a = 0; a = a + 1 ; return a; }"
assert 1 "main(){ {} return 1; }"
assert 1 "main(){ if(1== 3) 0; else 1; }"
assert 1 "main(){ int a; a = 1; if(a == 0){return 0;}else if(a==1){return 1;}else{return 2;} }"
assert 4 "main(){ int a; a = 0; while(a<4) a=a+1; return a; }"
assert 4 "main(){ int i; for(i = 0; i < 4; i = i+1) 1; return i; }"
...
assert 1 "main(){ int a; a = 1; int b; b = &a; return *b; }"
